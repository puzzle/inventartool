...
class AddInRepairToObjects < ActiveRecord::Migration
  def self.up
    add_column :servers, :in_repair, :boolean, :default => false
    add_column :notebooks, :in_repair, :boolean, :default => false
    add_column :disks, :in_repair, :boolean, :default => false
    add_column :rams, :in_repair, :boolean, :default => false
    add_column :displays, :in_repair, :boolean, :default => false
